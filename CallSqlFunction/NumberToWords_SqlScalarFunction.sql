...
ELSE IF(@lang = 'tr') begin
	SET @zero = 'Sıfır';
	-- Give special numbers until 100
	INSERT into @numericDetails values (1,'Bir'),(2,'İki'),( 3,'Üç'),(4,'Dört'),( 5,'Beş'),
	(6,'Altı'),(7,'Yedi'),(8,'Sekiz'),(9,'Dokuz'),(10,'On'),
	(11,'On Bir'),(12,'On İki'),(13,'On Üç'),(14,'On Dört'),
	(15,'On Beş'),(16,'On Altı'),(17,'On Yedi'),(18,'On Sekiz'),
	(19,'On Dokuz'),(20,'Yirmi'),(30,'Otuz'),(40,'Kırk'),
	...
	-- Even Digits
	(17,'QuinDecillion'),(19,'SepDecillion'),(21,'NovemDecillion'),
	(3,'Milyon'),(5,'Trillion'),(7,'Quintillion'),(9,'Septillion'),
	(11,'Nonillion'),(13,'UnDecillion'),(15,'TreDecillion'),(18,'SexDecillion'),
	(20,'OctoDecillion'),(22,'Vigintillion')
end
